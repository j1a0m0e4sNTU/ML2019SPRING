...
parser.add_argument('-conv', help= 'Symbol for conv layer configuration', default= 'base')
parser.add_argument('-fc', help= 'Symbol for fc layer configuration', default= 'base')
