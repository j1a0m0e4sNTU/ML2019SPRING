...
parser.add_argument('-dataset', help= 'Path to dataset', default= '../../data_hw7/images')
...
parser.add_argument('-testcase', default= '../../data_hw7/test_case.csv')
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        print('======= Training ========')
        data_train = DataLoader(Unlabeled(args.dataset, 'all'), batch_size= args.bs, shuffle= True)
